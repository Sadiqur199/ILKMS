                        ...
                        {treeData && (
                            <>
                                ...
                                {Object.keys(treeData).length > 0 && (
                                    ...
                                    <button className='btn btn-lg btn-info float-end' onClick={handleShow}>
                                ...
                                <Modal size="xl" scrollable={true} animation={true} show={show} onHide={handleClose}>
                                    <Modal.Header closeButton>
                                                    ...
                                                    <div>
                                                        ...
                                                        <map name="image_map">
                                                            ...
                                                            <area
                                                                ...
                                                                coords="287,627,402,686" shape="rect">
                                                            </area>
                                                            <area
                                                                ...
                                                                coords="289,719,399,781" shape="rect">
                                                            </area>
                                                            <area
                                                                ...
                                                                coords="286,810,400,875" shape="rect">
                                                            </area>
                                                            <area alt="" title="" href="" coords="426,812,1003,874"
                                                                  shape="rect">
                                                            </area>
                                                        </map>
                                                                    ...
                                                                    {treeData.map((tree, index) => (
                                                                        <div key={index}>
                                                                            {index === 0 ? null : (
                                                                                <p>
                                                                                    <img
                                                                                        src={axios.defaults.baseURL + "/tree.png"}
                                                                                        alt="Tree"/>
                                                                                </p>
                                                                            )}
                                                                            {tree.map((item, itemIndex) => (
                                                                                <small key={item.id}
                                                                                       title={item.year}><Link
                                    ...
                                    <Modal.Footer>
                                        <button className='btn btn-lg btn-info' onClick={handleClose}>
                                            বন্ধ করুন
                                        </button>
                                    </Modal.Footer>
                                </Modal>
