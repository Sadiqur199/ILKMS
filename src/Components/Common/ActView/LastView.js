    ...
    axios
      ...
      .then((res) => {
        ...
        if (res.data.live_data.length > 0) {
          ...
          setNumber(
            res.data.live_data[res.data.live_data.length - 1]
              .mod_by_act_id__number
          );
          setPost(
            res.data.live_data[res.data.live_data.length - 1].json_data__Act[0]
          );
        }
      })
      .catch((err) => {
  ...
  return (
    ...
    >
      ...
      <div className="ActInner_top">
        ...
        <h4>
          ( {post.act_year} সনের {post.number} নং আইন )
        </h4>
