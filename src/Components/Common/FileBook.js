...
{/*           <div>Page {pageNumber} of {numPages}</div>
      ...
      <Document file={axios.defaults.baseURL + "/uploads/" + post.system_generated_pdf} onLoadSuccess={handleDocumentLoadSuccess} >
{/*      <Document file='/pdf.pdf' onLoadSuccess={handleDocumentLoadSuccess} >*/}
{/*       <button onClick={() =>
