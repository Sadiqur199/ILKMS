...
const AddSection = ({actId}) => {
    ...
    const handleSectionNote = (event, editor) => {
        const data = editor.getData();
        setSectionNote(data);
    }
        ...
        axios.post("/api/section/create/",
            {
                ...
                note: sectionNote ? sectionNote : null,
            },
        )
            .then(response => {
    ...
    /*    const handleCreateAppendment = () => {
            await axios.post("/api/appendment/",
                {
                    jwt: token,
                    act_year: newSectionData.act_year,
                    act_id: newSectionData.act_id,
                                ...
                                <>
                                    <div style={{
                                        ...
                                        <TextField required={true} fullWidth label="শিরোনাম" variant="outlined" className='text_field'
                                                   value={sectionHeading} onChange={handleSectionHeading}
                                                   inputProps={{style: {height: '15px'}}}/>
                                    </div>
                                    {/*                    <TextField fullWidth label="বিষয়বস্তু" variant="outlined" className='text_field'
                               value={sectionContent} onChange={handleSectionContent}
                               inputProps={{style: {height: '15px'}}}/>*/}
                                    <br/>
