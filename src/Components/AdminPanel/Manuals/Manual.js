...
const Manual = () => {
    ...
    const handleCreateAct = () => {
        ...
        formData.append('ebooks_type', 'ম্যানুয়াল');
        ...
        axios.post("/api/act/create/", formData,
            ...
            .then(result => {
                toast.success('আপনার ম্যানুয়াল সফলভাবে তৈরি হয়েছে');
                navigate("/admin/manual/list")
            })
            .catch(error => {
                            ...
                            <div className='card'>
                                ...
                                <div className='card-body'>
                                    ...
                                    <div style={{
                                        ...
                                        <input type='date' className='w-100' value={publicationDate}
