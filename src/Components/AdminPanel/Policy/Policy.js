                        ...
                        <div className='col-md-12'>
                            <div className='card'>
                                <div className='card-header'>
                                    <b> নীতিমালা  যোগ করুন</b>
                                    <b className='float-end'>
                                        <Link to='/admin/policy/list'>
