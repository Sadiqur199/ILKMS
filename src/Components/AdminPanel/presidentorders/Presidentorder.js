...
/*    const [publicationYear, setPublicationYear] = useState("")*/
    ...
    const handleCreateAct = () => {
       ...
       /* formData.append('publication_year', publicationYear);*/
        ...
        formData.append('ebooks_type', 'রাষ্ট্রপতির আদেশ');
        ...
        axios.post("/api/act/create/", formData,
            ...
            .then(result => {
                navigate("/president/order/list")
                toast.success("রাষ্ট্রপতির আদেশ সফলভাবে তৈরি হয়েছে")
            })
            .catch(error => {
                        ...
                        <div className='col-md-12'>
                            <div className='card'>
                                <div className='card-header'>
                                    <b> রাষ্ট্রপতির আদেশ যোগ করুন</b>
                                    <b className='float-end'>
                                        <Link to='/president/order/list'>
                                            <button className='btn btn-lg btn-info'>
                                                <BackwardFilled/>
                                                রাষ্ট্রপতির আদেশ সমূহ দেখুন
                                            </button>
                                ...
                                <div className='card-body'>
                                    <TextField required={true} fullWidth label="শিরোনাম" variant="outlined"
                                               ...
                                               value={actTitle} onChange={handleActTitle}
...
{/*                                        <TextField required={true} fullWidth label="বছর" variant="outlined"
                                        ...
                                        <TextField fullWidth label="নম্বর" variant="outlined" className='text_field'
                                                   value={actNumber} onChange={handleActNumber}
                                                   inputProps={{style: {height: '15px'}}}/>
{/*                                        <TextField required={true} fullWidth label="প্রকাশনার তারিখ" variant="outlined"
                                        ...
                                        <input type='date' className='w-100' value={publicationDate} onChange={handlePublicationDate}/>
                                    ...
                                    <div style={{
                                        ...
                                        <div>
                                            <CKEditor className='text_field'
                                                      ...
                                                      config={{
                                                          placeholder: 'প্রস্তাব', // Add your placeholder text here
                                                      }}
                                            />
                                        </div>
                                        <div>
                                            <CKEditor className='text_field'
                                                      ...
                                                      config={{
                                                          placeholder: 'উদ্দেশ্য', // Add your placeholder text here
                                                      }}
                                            />
                                        </div>
                                    ...
                                    <div style={{
                                        ...
                                        <TextField  fullWidth label="সূত্র" variant="outlined"
                                                    className='text_field'
                                                    placeholder="সূত্র যোগ করুন"
                                                    value={motto}  onChange={event => setMotto(event.target.value)}
                                                    inputProps={{style: {height: '15px'}}}/>


                                        <TextField  fullWidth label="তৈরির তারিখ বাংলা" variant="outlined"
                                                    className='text_field'
                                                    placeholder="তারিখ যোগ করুন"
                                                    value={created_at_bn}  onChange={event => setCreatedAtBn(event.target.value)}
                                                    inputProps={{style: {height: '15px'}}}/>
                                        <TextField  fullWidth label="তৈরির তারিখ ইংরেজি" variant="outlined"
                                                    className='text_field'
                                                    placeholder={"তারিখ যোগ করুন"}
                                                    value={created_at_en}  onChange={event => setCreatedAtEn(event.target.value)}
                                                    inputProps={{style: {height: '15px'}}}/>

                                        <TextField  fullWidth label="প্রযোজ্য তারিখ বাংলা" variant="outlined"
                                                    className='text_field'
                                                    value={applicable_date_bn}  onChange={event => setApplicableDateBn(event.target.value)}
                                                    inputProps={{style: {height: '15px'}}}/>
                                        <TextField  fullWidth label="প্রযোজ্য তারিখ ইংরেজি" variant="outlined"
                                                    className='text_field'
                                                    value={applicable_date_en}  onChange={event => setApplicableDateEn(event.target.value)}
                                                    inputProps={{style: {height: '15px'}}}/>

                                        <TextField  fullWidth label="হেডিং" variant="outlined"
                                                    className='text_field'
                                                    value={heading}  onChange={event => setHeading(event.target.value)}
                                                    inputProps={{style: {height: '15px'}}}/>

                                        <TextField  fullWidth label="শাখা" variant="outlined"
                                                    className='text_field'
                                                    value={branch}  onChange={event => setBranch(event.target.value)}
                                                    inputProps={{style: {height: '15px'}}}/>

                                        <TextField  fullWidth label="উপ-শাখা" variant="outlined"
                                                    className='text_field'
                                                    value={subBranch}  onChange={event => setSubBranch(event.target.value)}
                                                    inputProps={{style: {height: '15px'}}}/>
                                        <TextField  fullWidth label="স্মারক নম্বর" variant="outlined"
                                                    className='text_field'
                                                    value={actNumber} onChange={event => setActNumber(event.target.value)}
                                                    inputProps={{style: {height: '15px'}}}/>
                                        <TextField  fullWidth label="স্বাক্ষরকারীর নাম" variant="outlined"
                                                    className='text_field'
                                                    value={signatures} onChange={event => setSignatures(event.target.value)}
                                                    inputProps={{style: {height: '15px'}}}/>
                                        <TextField  fullWidth label="স্বাক্ষরকারীর পদবি " variant="outlined"
                                                    className='text_field'
                                                    value={signature_position} onChange={event => setSignaturePosition(event.target.value)}
                                                    inputProps={{style: {height: '15px'}}}/>
                                        <TextField  fullWidth label="তৈরীকারক" variant="outlined"
                                                    className='text_field'
                                                    value={createdBy} onChange={event => setCreatedBy(event.target.value)}
                                                    inputProps={{style: {height: '15px'}}}/>

                                        <TextField  fullWidth label="অনুলিপি" variant="outlined"
                                                    className='text_field'
                                                    value={copyTo} onChange={event => setCopyTo(event.target.value)}
                                                    inputProps={{style: {height: '15px'}}}/>
                                        ...
                                        <TextField  fullWidth label="মেটা কীওয়ার্ডস" variant="outlined"
                                                    className='text_field'
                                                    placeholder='আইন, নামজারি'
                                                    value={meta_keywords} onChange={event => setMetaKeywords(event.target.value)}
                                                    inputProps={{style: {height: '15px'}}}/>
                                        <TextField  fullWidth label="রেফারেন্স" variant="outlined"
                                                    className='text_field'
