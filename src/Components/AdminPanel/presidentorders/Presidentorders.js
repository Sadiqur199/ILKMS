...
const Presidentorders = () => {
    ...
    const handleNavigate = () => {
        navigate('/admin/president/order/add')
    }
    const handleAction = () => {
        navigate('/action')
    }
                        ...
                        <div className='card mt-4'>
                            <div className='card-header text-center'>
                                ...
                                <div className='float-end' onClick={handleNavigate}>
                                    <AddSomething addText={" রাষ্ট্রপতির আদেশ লিপিবদ্ধকরুণ"}/>
                                </div>
                            </div>
...
{/*                                <th scope="col">পরিদর্শন মূল আইন </th>
                            ...
                            {actList.map((eachAct, index) => (
                                <tr key={index}>
                                    ...
                                    <th scope="row"><Link to={"/ebook/temp/view/" + eachAct.id}>{convertToBengaliNumber(index+1)}</Link></th>
