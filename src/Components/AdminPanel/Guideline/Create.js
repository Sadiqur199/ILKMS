...
/*    const [proposal, setProposal] = useState("")*/
    ...
    const handleCreateAct = () => {
        ...
        formData.append('ebooks_type', 'নির্দেশিকা');
        ...
        axios.post("/api/act/create/", formData,
            ...
            .then(result => {
                toast.success('নির্দেশিকা সফলভাবে তৈরি হয়েছে');
                navigate("/admin/guideline/list")
            })
            .catch(error => {
