...
const AddSubSection = ({actId, sectionId}) => {
   ...
   /* const navigate = useNavigate()*/
    ...
    const handlePostRepealed = async () => {
        const response = await axios.post(
            "/api/repealed/",
            {
                ...
                /*  repealed_to_sub_section_id: newSubSectionData.sub_section_id ? newSubSectionData.sub_section_id : null,*/
    ...
    const handleSubSectionContent = (event, editor) => {
        const data = editor.getData();
        setSubSectionContent(data);
    }
                ...
                <>
                    <div style={{
                        ...
                        <TextField fullWidth label="উপধারা নম্বর" variant="outlined" className='text_field'
                                   value={subSectionNo} onChange={handleSubSectionNo}
                                   inputProps={{style: {height: '15px'}}}/>
                    </div>
                    {/*
                    <TextField fullWidth label="বিষয়বস্তু" variant="outlined" className='text_field'
                               value={subSectionContent} onChange={handleSubSectionContent}
                               inputProps={{style: {height: '15px'}}}/>
*/}
...
<br/>
                    <CKEditor className='text_field'
                              ...
                              onChange={handleSubSectionContent}
                              config={{
                                  placeholder: 'বিষয়বস্তু', // Add your placeholder text here
                              }}
                    />
...
{/*
                                            <TextField fullWidth label="বিষয়বস্তু" variant="outlined"
                                                       className='text_field'
                                                       value={appendmentContent} onChange={handleAppendmentContent}
                                                       inputProps={{style: {height: '15px'}}}/>
